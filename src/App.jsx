    ...
    return (
        <>
            ...
            <main>
                ...
                <Product
                    image={limoen}
                    alt="Plaatje van een limoen"
                    title="Limoen"
                    description="Limoen is familie van de citroen en de sinaasappel en behoort tot de citrusvruchten (Wijnruitfamilie). Limoenen zijn rond en kleiner dan citroenen. De schil is dun, vrij glad en
                        groen."
                />
                <Product
                    image={ijsblokjes}
                    alt="Plaatje van ijsblokjes"
                    title="IJsblokjes"
